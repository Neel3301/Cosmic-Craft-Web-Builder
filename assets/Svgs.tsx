    ...
    >
      <defs>
        ...
        >
          ...
          <stop offset="0.26" stopColor="#f47133"></stop>
          <stop offset="0.61" stopColor="#bc3081"></stop>
...
const SocialInstagramIcon = ({ classname }: iconProps) => {
  return (
    <svg
      ...
      className={`${classname}`}
    >
      <g fill="#fff" clipPath="url(#clip0_17_63)">
...
const CrossIcon = ({ classname }: iconProps) => {
  return (
    <svg
      ...
      className={`${classname}`}
    >
      <path fill="none" d="M0 0h24v24H0Z" data-name="Path 3730"></path>
      <path
        fill="#424242"
